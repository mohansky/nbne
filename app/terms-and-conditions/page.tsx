    ...
    <Container width="marginxy">
      <div className="max-w-4xl">
        ...
        <P>
          ...
          https://nnejourneys.com/ if you do not agree to take all of the terms
          ...
          and all Agreements: &quot;Client&quot;, &quot;You&quot; and
        ...
        <ul className="list-disc ml-5 my-3 space-y-2">
          ...
          <li>
            Reproduce, duplicate or copy material from https://nnejourneys.com/
          </li>
        ...
        <P>
          ...
          by applicable laws, North by Northeast Journeys shall not be liable
        ...
        <P>
          North by Northeast Journeys reserves the right to monitor all Comments
        ...
        <P>
          ...
          sending an e-mail to North by Northeast Journeys. Please include your
